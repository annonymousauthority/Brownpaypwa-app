<template>
  ...
  <div class="mx">
    <h5 class="font-bold pt-10 text-5xl">
     Learn About<span class="title">Crypto</span>
    </h5>
    <h4 class="mb-10">
      <span
        >Get access to practical guides to begin your crypto 
        journey and how BrownPay works.</span
      >
    </h4>
  </div>
  <!--End of Heaing-->
  <Carousel/>
    ...
    <div
      ...
      "
    >
      <h5 class="text-left text-3xl font-bold mb-10">Getting Started</h5>
      <div
